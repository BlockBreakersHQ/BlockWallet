...
impl Tokens {
    pub fn new() -> Self {
        let token_transfers = HashMap::<String, TransferMethods>::from([
            ...
            ("0x467bccd9d29f223bce8043b84e8c8b282827790f".to_string(), TransferMethods::transfer_from), // TEL
            ("0xe9a95d175a5f4c9369f3b74222402eb1b837693b".to_string(), TransferMethods::transfer_from), // NOW
            ("0xa4bdb11dc0a2bec88d24a3aa1e6bb17201112ebe".to_string(), TransferMethods::transfer_from), // USDS
            ("0xc82e3db60a52cf7529253b4ec688f631aad9e7c2".to_string(), TransferMethods::transfer_from), // ARC
            ("0xfc05987bd2be489accf0f509e44b0145d68240f7".to_string(), TransferMethods::transfer_from), // ESS
            ("0x6fb3e0a217407efff7ca062d46c26e5d60a14d69".to_string(), TransferMethods::transfer_from), // IOTX
            ("0x6c6ee5e31d828de241282b9606c8e98ea48526e2".to_string(), TransferMethods::transfer_from), // HOT
            ("0x0ae055097c6d159879521c384f1d2123d1f195e6".to_string(), TransferMethods::transfer_from), // STAKE
            ("0xfc82bb4ba86045af6f327323a46e80412b91b27d".to_string(), TransferMethods::transfer_from), // PROM
            ("0x05079687d35b93538cbd59fe5596380cae9054a9".to_string(), TransferMethods::transfer_from), // BTSG
            ("0x89bd2e7e388fab44ae88bef4e1ad12b4f1e0911c".to_string(), TransferMethods::transfer_from),// NUX
            ("0x814e0908b12a99fecf5bc101bb5d0b8b5cdf7d26".to_string(), TransferMethods::transfer_from), // MDT
            ("0x4de2573e27e648607b50e1cfff921a33e4a34405".to_string(), TransferMethods::transfer_from), // LST
            ("0x5adc961d6ac3f7062d2ea45fefb8d8167d44b190".to_string(), TransferMethods::transfer_from), // DTH
            ("0xcf3c8be2e2c42331da80ef210e9b1b307c03d36a".to_string(), TransferMethods::transfer_from), // BEPRO
            ("0x340d2bde5eb28c1eed91b2f790723e3b160613b7".to_string(), TransferMethods::transfer_from), // VEE
            ("0x408e41876cccdc0f92210600ef50372656052a38".to_string(), TransferMethods::transfer_from), // REN
            ("0xb9ef770b6a5e12e45983c5d80545258aa38f3b78".to_string(), TransferMethods::transfer_from), // ZCN
            ("0xe48972fcd82a274411c01834e2f031d4377fa2c0".to_string(), TransferMethods::transfer_from), // 2KEY
            ("0x178c820f862b14f316509ec36b13123da19a6054".to_string(), TransferMethods::transfer_from), // EWTB
            ("0x6f259637dcd74c767781e37bc6133cd6a68aa161".to_string(), TransferMethods::transfer_from), // HT
            ("0xc28e931814725bbeb9e670676fabbcb694fe7df2".to_string(), TransferMethods::transfer_from), // eQUAD
            ("0xebd9d99a3982d547c5bb4db7e3b1f9f14b67eb83".to_string(), TransferMethods::transfer_from), // ID
            ("0xddb3422497e61e13543bea06989c0789117555c5".to_string(), TransferMethods::transfer_from), // COTI
            ("0xee573a945b01b788b9287ce062a0cfc15be9fd86".to_string(), TransferMethods::transfer_from), // XED
            ("0x0e8d6b471e332f140e7d9dbb99e5e3822f728da6".to_string(), TransferMethods::transfer_from), // ABYSS
            ("0x83e6f1e41cdd28eaceb20cb649155049fac3d5aa".to_string(), TransferMethods::transfer_from), // POLS
            ("0x10633216e7e8281e33c86f02bf8e565a635d9770".to_string(), TransferMethods::transfer_from), // DVI
            ("0x08d967bb0134f2d07f7cfb6e246680c53927dd30".to_string(), TransferMethods::transfer_from), // MATH
            ("0x58b6a8a3302369daec383334672404ee733ab239".to_string(), TransferMethods::transfer_from), // LPT
            ("0xc4f6e93aeddc11dc22268488465babcaf09399ac".to_string(), TransferMethods::transfer_from), // HI
            ("0x8207c1ffc5b6804f6024322ccf34f29c3541ae26".to_string(), TransferMethods::transfer_from), // OGN
            ("0x967da4048cd07ab37855c090aaf366e4ce1b9f48".to_string(), TransferMethods::transfer_from), // OCEAN
            ("0x4946fcea7c692606e8908002e55a582af44ac121".to_string(), TransferMethods::transfer_from), // FOAM
            ("0x4730fb1463a6f1f44aeb45f6c5c422427f37f4d0".to_string(), TransferMethods::transfer_from), // FOUR
            ("0x9992ec3cf6a55b00978cddf2b27bc6882d88d1ec".to_string(), TransferMethods::transfer_from), // POLY
            ("0x0f71b8de197a1c84d31de0f1fa7926c365f052b3".to_string(), TransferMethods::transfer_from), // ARCONA
            ("0x80fb784b7ed66730e8b1dbd9820afd29931aab03".to_string(), TransferMethods::transfer_from), // LEND
            ("0xc719d010b63e5bbf2c0551872cd5316ed26acd83".to_string(), TransferMethods::transfer_from), // DIP
            ("0x6a7ef4998eb9d0f706238756949f311a59e05745".to_string(), TransferMethods::transfer_from), // KEN
            ("0xd559f20296ff4895da39b5bd9add54b442596a61".to_string(), TransferMethods::transfer_from), // FTX
            ("0xbbbbca6a901c926f240b89eacb641d8aec7aeafd".to_string(), TransferMethods::transfer_from), // LRC
            ("0xcca0c9c383076649604ee31b20248bc04fdf61ca".to_string(), TransferMethods::transfer_from), // BTMX
            ("0x5cf04716ba20127f1e2297addcf4b5035000c9eb".to_string(), TransferMethods::transfer_from), // NKN
            ("0x5b09a0371c1da44a8e24d36bf5deb1141a84d875".to_string(), TransferMethods::transfer_from), // MAD
            ("0x4c11249814f11b9346808179cf06e71ac328c1b5".to_string(), TransferMethods::transfer_from), // ORAI
            ("0x2260fac5e5542a773aa44fbcfedf7c193bc2c599".to_string(), TransferMethods::transfer_from), // WBTC
            ("0x8c543aed163909142695f2d2acd0d55791a9edb9".to_string(), TransferMethods::transfer_from), // VLX
            ("0xff56cc6b1e6ded347aa0b7676c85ab0b3d08b0fa".to_string(), TransferMethods::transfer_from), // ORBS
            ("0x543ff227f64aa17ea132bf9886cab5db55dcaddf".to_string(), TransferMethods::transfer_from), // GEN
            ("0xe1c7e30c42c24582888c758984f6e382096786bd".to_string(), TransferMethods::transfer_from), // XCUR
            ("0x8eb24319393716668d768dcec29356ae9cffe285".to_string(), TransferMethods::transfer_from), // AGI
            ("0x514910771af9ca656af840dff83e8264ecf986ca".to_string(), TransferMethods::transfer_from), // LINK
            ("0xd478161c952357f05f0292b56012cd8457f1cfbf".to_string(), TransferMethods::transfer_from), // POLK
            ("0xbf2179859fc6d5bee9bf9158632dc51678a4100e".to_string(), TransferMethods::transfer_from), // ELF
            ("0x68d57c9a1c35f63e2c83ee8e49a64e9d70528d25".to_string(), TransferMethods::transfer_from), // SRN
            ("0xbc86727e770de68b1060c91f6bb6945c73e10388".to_string(), TransferMethods::transfer_from), // XNK
            ("0xd15ecdcf5ea68e3995b2d0527a0ae0a3258302f8".to_string(), TransferMethods::transfer_from), // MCX
            ("0xa0cf46eb152656c7090e769916eb44a138aaa406".to_string(), TransferMethods::transfer_from), // SPH
            ("0xb26631c6dda06ad89b93c71400d25692de89c068".to_string(), TransferMethods::transfer_from), // MINDS
            ("0x4a220e6096b25eadb88358cb44068a3248254675".to_string(), TransferMethods::transfer_from), // QNT
            ("0x5c872500c00565505f3624ab435c222e558e9ff8".to_string(), TransferMethods::transfer_from), // COT
            ("0x3a9fff453d50d4ac52a6890647b823379ba36b9e".to_string(), TransferMethods::transfer_from), // SHUF
            ("0x8290333cef9e6d528dd5618fb97a76f268f3edd4".to_string(), TransferMethods::transfer_from)  // ANKR
        ]);
